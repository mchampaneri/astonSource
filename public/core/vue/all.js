...
exports.default = {
    ...
    ready: function ready() {
        var vm = this;
        this.$http.get('/workspace/faculty/assignments/1').then(function (data) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-48418db6", module.exports)
  } else {
    hotAPI.update("_v-48418db6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./components/Question.vue":1,"vue":6,"vue-resource":5}],3:[function(require,module,exports){
